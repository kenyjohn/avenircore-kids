...
const orgSchema = {
  ...
  founder: { '@type': 'Person', name: 'John & Abigail Kennedy' },
  foundingDate: '2026',
  ...
  <>
    ...
    <div style={{ padding: '4rem 0', background: 'var(--color-bg)' }}>
      <div className="container" style={{ maxWidth: '860px' }}>
        ...
        {/* Founder section */}
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '3rem', alignItems: 'start', marginBottom: '4rem' }}>
          <div>
            <div style={{ width: '120px', height: '120px', borderRadius: '50%', background: 'linear-gradient(135deg, var(--color-emerald) 0%, var(--color-navy) 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '2.5rem', marginBottom: '1rem' }}>
              👨‍💻
            </div>
        ...
        <div style={{ background: 'var(--color-emerald-bg)', borderRadius: 'var(--radius-xl)', border: '1.5px solid var(--color-emerald-soft)', padding: '2.5rem', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <button className="btn btn-outline" onClick={() => window.location.href = '/#waitlist'}>Join the Waitlist</button>
          </div>
        </div>
